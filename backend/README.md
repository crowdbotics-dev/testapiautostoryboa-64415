...
## Project Structure
    ...
    ├── testapiautostoryboa_64415  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_64415`
...
2. Clone this repo and `cd testapiautostoryboa_64415`
